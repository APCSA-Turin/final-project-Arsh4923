...
public class App { // the user is going to enter the names of 2 Pokémon they would like to compare to know which one is better for which part of the game
    ...
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            System.out.println("Pokémon Evolution Comparison Tool");
    ...
    private static List<String> getEvolutionChain(String name) throws Exception {List<String> chain = new ArrayList<>();
...
// and this comparing is done for all the forms of that pokemon and also for Mega evolution
    ...
    private static void compareEvolutions(List<String> evo1, List<String> evo2) throws Exception {
        System.out.println("\n=== Comparison Results ===");
...
// This part of the program is used only when the pokemon has a mega evolution and gets the last element in evolution list and sees if it is a mega
    ...
    // This method is used to print the information of the pokemon during each evolution/stage and gives the information of the pokemon like the stats
    ...
    private static void compareFinalForms(String name1, JSONObject p1, String name2, JSONObject p2, String type) {
        double avg1 = getAverageStats(p1);
        double avg2 = getAverageStats(p2);
    ...
    // This method is important since it finds which pokemon has teh higher average base stats which compares them using this.
